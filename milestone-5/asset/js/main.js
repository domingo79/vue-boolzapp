const app = new Vue({
    ...
    methods: {
        ...
        cancella(index) {
            console.log(index);
            let conferma = confirm('Vuoi Eliminare Definitivamente?');
            if (conferma === true) {
        ...
        info(index) {
            if (this.contacts[this.counter].messages[index].status === 'sent') {
                alert('messaggio spedito il: ' + this.contacts[this.counter].messages[index].date);
                //console.log('messaggio spedito');
                //console.log(this.contacts[this.counter].messages[index].date);
            } else {
                alert('messaggio ricevuto il: ' + this.contacts[this.counter].messages[index].date);
                //console.log('messaggi ricevuto');
                //console.log(this.contacts[this.counter].messages[index].date);
            }
        }
